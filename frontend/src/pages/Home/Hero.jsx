  ...
  return (
    <div className="w-full max-w-7xl mx-auto py-6 font-sans">
      <div className="bg-white border border-gray-200 rounded-lg p-4 flex flex-col lg:flex-row gap-4">
        ...
        {/* Note: Replace the background color/gradient with your actual background image URL */}
        <div 
        ...
        >
          <h3 className="text-2xl text-gray-800 mb-1 relative z-10">Latest trending</h3>
          <h2 className="text-4xl font-bold text-gray-900 mb-6 relative z-10">Electronic items</h2>
        ...
        <div className="flex flex-col w-full lg:w-[240px] shrink-0 gap-3">
          ...
          <div className="bg-[#e3f0ff] rounded-lg p-4 flex flex-col">
            ...
            <button className="w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 rounded-md text-sm transition-colors mb-2">
              Join now
            </button>
            <button className="w-full bg-white hover:bg-gray-50 text-blue-500 font-medium py-2 rounded-md text-sm border border-gray-200 transition-colors">
              Log in
            </button>
          </div>
